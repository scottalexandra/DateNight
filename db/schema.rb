...
ActiveRecord::Schema.define(version: 20150314215246) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "event_objects", force: :cascade do |t|
    t.string   "title"
    t.string   "url"
  ...
  add_index "itinerary_events", ["event_object_id"], name: "index_itinerary_events_on_event_object_id", using: :btree
  ...
  add_foreign_key "itinerary_events", "event_objects"
